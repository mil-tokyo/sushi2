...
var MatrixCL = (function (_super) {
    ...
    MatrixCL.prototype.get_matrix_single = function (singleind) {
    ...
    MatrixCL.prototype.get_matrix_logical = function (map) {
    ...
    MatrixCL.prototype.set_matrix_logical = function (val, map) {
        //not paralleled; very slow
        //first, count output size
        var map_cl;
        var destruct_map_cl = false;
